  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contractor as @contractor" do
        ...
        post :create, {:contractor => {}}, valid_session
        assigns(:contractor).should be_a_new(Contractor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contractor" do
        ...
        put :update, {:id => contractor.to_param, :contractor => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contractor as @contractor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contractor.any_instance.stub(:save).and_return(false)
        put :update, {:id => contractor.to_param, :contractor => {}}, valid_session
        assigns(:contractor).should eq(contractor)
      end
